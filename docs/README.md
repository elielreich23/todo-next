...
Project documentation is organized by topic below.

## Setup & Development

- **[Setup and Development Guide](./setup/SETUP_AND_DEVELOPMENT.md)** - Local setup, development workflow, and troubleshooting
- **[Feature Summary](./setup/FEATURE_SUMMARY.md)** - Feature checklist and roadmap reference
- **[Authentication Setup](./setup/AUTHENTICATION_SETUP.md)** - Google OAuth and password reset setup
- **[Google OAuth Setup](./setup/GOOGLE_OAUTH_SETUP.md)** - Detailed Google OAuth configuration
- **[Auth Implementation Summary](./setup/AUTH_IMPLEMENTATION_SUMMARY.md)** - Summary of implemented authentication features
...
- **[client/README.md](../client/README.md)** - Install, scripts, and environment variables for the Next.js app
