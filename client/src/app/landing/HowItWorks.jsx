      ...
      <div className={styles.container}>
        ...
        <div className={styles.steps}>
          <div className={styles.step}>
            <div className={styles.stepIcon}>
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M22 21V19C22 18.1137 21.7315 17.2358 21.2072 16.4999C20.683 15.7641 19.9291 15.2149 19.0709 14.9267C18.2127 14.6385 17.2859 14.6259 16.4197 14.8907C15.5535 15.1555 14.7894 15.6869 14.2148 16.416L22 21Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          ...
          <div className={styles.step}>
            ...
            <h3 className={styles.stepTitle}>Start Tasking</h3>
          </div>
        </div>
      </div>
    </section>
