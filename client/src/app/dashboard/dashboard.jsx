      ...
      <div className={`white-sidebar ${isWhiteSidebarOpen ? 'open' : ''}`} ref={whiteSidebarRef}>
        <div className="sidebar-header">
          ...
          <div className="header-actions">
            <button className="add-btn" onClick={openProjectWizard} title="Create project" aria-label="Create project">
        ...
        <div className="sidebar-content">
          ...
          <div className={`section ${isProjectsOpen ? 'open' : ''}`}>
            <div className="section-header">
              <h3>Projects</h3>
              <button className="add-btn small" onClick={openProjectWizard} title="Create project" aria-label="Create project">
